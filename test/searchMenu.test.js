...
describe("Menu Search", function () {
    ...
    it("TC01: Should display menu information when searching with a valid menu name", async function () {
...
it("TC02: Should display all menu items containing the searched character", async function () {
    this.timeout(10000000);
...
it("TC03: Should display message 'Please enter menu name' when click search without empty input", async function () {
    this.timeout(10000000);
...
it("TC04: Should display message 'Menu not found!!' when search with invalid menu name.", async function () {
    this.timeout(10000000);
...
it("TC05: Should display message 'Menu not found!!' when search with character that are not part of all menu name.", async function () {
    this.timeout(10000000);
