...
describe("Alert status", function () {
  ...
  it("TC01: Should display alert when status changed ", async function () {
    ...
    try {
      ...
      await usernameField.sendKeys('aom');
  ...
  it("TC02: If status change should display alert with alert message same current status", async function () {
    this.timeout(10000000);
  ...
  it("TC03: Should not display alert when status not changed", async function () {
    this.timeout(10000000);
    ...
    try {
      ...
      await usernameField.sendKeys('super_z');
      await passwordField.sendKeys('user1234');
